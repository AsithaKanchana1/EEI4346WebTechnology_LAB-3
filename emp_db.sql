...
ALTER TABLE `emp_dept_map`
  ADD CONSTRAINT `emp_dept_map_ibfk_1` FOREIGN KEY (`EMP_DEPT`) REFERENCES `emp_dept` (`EMP_DEPT`),
  ADD CONSTRAINT `emp_dept_map_ibfk_2` FOREIGN KEY (`EMP_ID`) REFERENCES `emp_country` (`EMP_ID`);
COMMIT;
